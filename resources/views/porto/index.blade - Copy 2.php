    ...
    <div class="body">
        ...
        <div role="main" class="main">
            ...
            <section class="section  m-0">
                <div class="section-angled-layer-top section-angled-layer-increase-angle"></div>
                <div class="container container-lg">
                    <div class="col-md-6">
                            ...
                            <div class="appear-animation" data-appear-animation="fadeInLeftShorter"
                                ...
                                <div class="strong-shadow rounded strong-shadow-top-right">
                                    <div
                                        ...
                                        <iframe src="{{$url}}" frameborder='0' allowfullscreen width="600px"
                                            height="450px"></iframe>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 order-lg-3">
                        <aside class="sidebar">
                            ...
                            <div class="owl-carousel owl-theme"
                                ...
                                @foreach($populer as $index => $p)
                                <div>
                                    <a href="{{url('berita')}}/{{$p->seo}}/{{$p->id_berita}}">
                                        <article>
                                            <div
