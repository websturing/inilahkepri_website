            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <a href="{{url('/videos')}}/{{$b->video_id}}/{{$b->seo}}">
                        <img src="{{$b->thumb}}" class="img-fluid rounded mb-2" style="height: 200px; width: 100%; object-fit: cover;" alt="{{$b->title}}">
                        <h5 class="text-color-dark font-weight-bold line-height-3 text-3 mb-1 pb-1" style="min-height: 55px;">
